...
public class newton_test_time {
	public static void main(String[] args) {
		...
		First_Order_Factory_efficient.experiment_with_iterations_complexity(1, loss.clone_loss(), 60, -1, Input.loss_test, Input.config.logDir+"_newton_time", Input.L, false,n);
	}
}
